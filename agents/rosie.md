...
5. Auditor receipts — check `receipts/correctness/`, `receipts/quality/`, etc. for issues flagged that tests should cover.

**Write to:**
- `receipts/tests/{chain_id}-{step}.md` — your receipt
- `logs/tests/` — optional logs
...
**Path:** `receipts/tests/{chain_id}-{step}.md`
