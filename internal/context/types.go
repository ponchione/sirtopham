...
//
// Common Type values are: "file_ref", "file_ref_rejected", "symbol_ref",
// "modification_intent", "creation_intent", "git_context", "continuation",
// "question_intent", "brain_intent", "brain_seeking_intent", and
// "debugging_hints".
type Signal struct {
