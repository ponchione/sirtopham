...
func brainIndexStaleReminder() string {
	return "Derived brain metadata and semantic chunks are now stale. Run `yard brain index` to refresh them. Check Settings or `/api/project` for current brain index status."
}
